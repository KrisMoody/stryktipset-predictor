<template>
  <UContainer class="py-8">
    ...
    <div class="space-y-6">
        ...
        <template #header>
          <div class="flex items-center justify-between">
            ...
            <UBadge
              ...
              variant="soft"
            >
              {{ selectedMode === 'ai' ? 'AI-Based' : selectedMode === 'r-system' ? 'R-System' : 'U-System' }}
            </UBadge>
          </div>
        </template>
      ...
      <UCard v-if="selectedSystem && aiPredictions && (selectedMode === 'r-system' || (selectedMode === 'u-system' && Object.keys(utgangstecken).length > 0))">
        <template #header>
          <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold">
...
import type { BettingSystem, CouponSelection, SystemCoupon, OptimalCoupon, MGExtension, CouponStatus } from '~/types'
