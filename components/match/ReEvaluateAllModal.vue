      ...
      <div class="space-y-4">
        ...
        <div v-else-if="costEstimate" class="space-y-4">
          ...
          <p class="text-sm text-gray-600 dark:text-gray-400">
            This will re-evaluate predictions for all {{ costEstimate.matchCount }} matches in this
            draw using Claude Sonnet 4.5. The actual cost may vary slightly based on match data
            complexity.
          </p>

          <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-3">
            <div class="flex items-start gap-2">
              <UIcon name="i-heroicons-information-circle" class="w-4 h-4 text-gray-400 mt-0.5" />
